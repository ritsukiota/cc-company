...
- **役割**: フリーランス
- **ワークスタイル**: 不規則・柔軟（日によってスケジュールが変わる）
- **言語**: ja
- **作成日**: 2026-04-02
...
- **research**: 調査・リサーチの記録。1トピック1ファイル。サブフォルダ: market/, competitors/
- **finances**: 財務管理と請求書。
- **meetings**: 議事録とアクションアイテム。

## ファイル命名規則

- **日次ファイル**: `YYYY-MM-DD.md`（例: `2026-04-02.md`）
...
- フリーランスとして不規則なスケジュールで働いている
- 柔軟な管理が必要。厳密なルーティンより、素早くキャプチャして後で整理するスタイルが合う
- クライアント管理・財務管理がビジネス上重要
